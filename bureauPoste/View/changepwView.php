    ...
    <div class="container">
        <form  id="formchangepw" method="POST" action="#">
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-4">
              <input type="password" name="oldpasseword" class="form-control text-center"  placeholder="********" id="old">
            </div>
          </div>
          <div class="form-group row">
                <label class="col-sm-4 label-form">Le nouveau mot de passe</label>
                  <div class="col-sm-4">
              <input type="password" name="newpassword" id="newpassword" class="form-control text-center"  placeholder="*********">
            </div>
          </div>
          <div class="form-group row">
                <label class="col-sm-4 label-form">Confirmer le nouveau mot de passe</label>
                  <div class="col-sm-4">
                    <input type="password" name="confirmenewpassword" class="form-control text-center"  placeholder="*********" id="confirmenewpassword">
                  </div>
          </div>
          <div class="row">
