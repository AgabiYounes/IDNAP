...
<head>
  ...
  <title>IDN Algérie Poste -Bureau de Poste</title>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <img src="../public/img/logo.png" height="30px" width="30px" id='logo-template' style="margin-right:10px"><a class="navbar-brand" href="index.php" style="font-size: 25px ">Bureau de Poste</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="tables.php">
            ...
            <span class="nav-link-text">Table des Personnes</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="services.php">
            <i class="fas fa-archive"></i>
            <span class="nav-link-text">Services Postaux</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
          <a class="nav-link" href="charts.php">
            <i class="fas fa-chart-pie"></i>
            <span class="nav-link-text">Statistiques BP</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="notify.php">
            <i class="fas fa-bell"></i>
            <span class="nav-link-text">Notifier un client</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
