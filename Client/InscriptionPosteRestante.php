...
<head>
	...
	<title>Inscription a la poste restante | IDN Algérie Poste</title>
</head>
		                ...
		                <div class="card wizard-card" data-color="orange" id="wizardProfile">
		                    <form action="#" method="POST">
		                    	<div class="wizard-header text-center">
		                        	<h3 class="wizard-title">La poste restante</h3>
		                                             ...
		                                             <select name="bp" class="form-control" required>
		                                                ...
		                                                <?php  } $table2->closeCursor();  ?>
              											...
              											<div class="form-group">
              												...
              												<input name="dateFin" type="date" class="form-control" placeholder="01/02/2018" min="" required>
              											</div>
