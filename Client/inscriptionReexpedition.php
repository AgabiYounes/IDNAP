...
<head>
	...
	<title>Inscription au service de la reexpedition | IDN Algérie Poste</title>
</head>
		                ...
		                <div class="card wizard-card" data-color="orange" id="wizardProfile">
		                    <form action="#" method="POST">
		                    	<div class="wizard-header text-center">
		                        	<h3 class="wizard-title">La Réexpéditons des couriers</h3>
		                                ...
		                                <div class="row">
		                                    ...
		                                    <div class="col-sm-7 col-sm-offset-1">
		                                    	<div class="form-group">
		                                            <label>Choisissez le bureau de poste ou vous voulez réccuperer votre courier.</label>
              								...
              								<div class="form-group">
              													...
              													<input name="dateFin" type="date" class="form-control" placeholder="01/02/2018" required>
              												</div>
