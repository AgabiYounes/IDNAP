...
<head>
  ...
  <title>IDN Algérie Poste -admin</title>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <img src="../public/img/logo.png" height="30px" width="30px" id='logo-template' style="margin-right:10px"><a class="navbar-brand" href="index.php" style="font-size: 25px ">Administrateur</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="tables.php">
            ...
            <span class="nav-link-text">Table des wilayas</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
          <a class="nav-link" href="charts.php">
            <i class="fas fa-chart-pie"></i>
            <span class="nav-link-text">Statistiques National</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="accountmanage.php">
            <i class="fas fa-user-circle"></i>
            <span class="nav-link-text">Gerer les sessions</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
