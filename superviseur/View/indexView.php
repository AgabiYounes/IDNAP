<?php ob_start(); ?>
<div class="content-wrapper" onload="startTime()">
          ...
          <div class="col-xl-4 col-sm-6 mb-3">
            <div class="card text-black o-hidden h-100" style="background-color:#318CE7;">
              <div class="card-body">
                ...
                <div class="mr-5" style="font-size: 20px"><strong>Nom de la wilaya</strong></div>
              </div>
              <div class="card-footer text-black clearfix small z-1" href="#">
                <span class="float-left nbr-inscription"><?php echo $wilaya; ?></span>
